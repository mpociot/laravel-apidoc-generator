...
/*
 * Each entry in this array describes settings for documenting an API within your project.
 * For most projects, you only have a single API, so you only need one entry here.
 * If you are building multiple APIs within the same codebase, and you want them
 * documented separately, all you need to do is add an entry for each API/
 */
return [
    [
        /*
         * The type of output to generate. Use `static` if you want  set of static HTML/CSS/JS files
         * served from your public folder, accessible to everyone. Use `laravel` if you want Blade
         * views with routing through Laravel.
         */
        'output' => 'static',

        /*
         * Tf you're generating documentation for multiple APIs, you need an `id` to distinguish
         * them. This id will be used as the name of the subfolders where the documentation source
         * files and output are stored. For `laravel` output (see above), this will be used as
         * the name of the Blade view, and Postman collection file.
         */
        'id' => 'docs',
